...
public class YupBank implements  Bank{
    private String AccNumber;
    private double balance;
    private String passkey;
    public static final double rateOfInterest = 12.25;
    public static final int minBalanced = 2000;
    YupBank(double balance,String passkey)
    {
